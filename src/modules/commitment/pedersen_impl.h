...
/* sec * G +/- value * G2. */
SECP256K1_INLINE static void secp256k1_pedersen_ecmult_generic(secp256k1_gej *rj, const secp256k1_scalar *sec, uint64_t value, const secp256k1_ge* value_gen, const secp256k1_ge* blind_gen, int minus_flag) {
    secp256k1_scalar vs;
    secp256k1_gej bj;
    secp256k1_ge bp;
...
/* sec * G - value * G2. */
SECP256K1_INLINE static void secp256k1_pedersen_minus_ecmult(secp256k1_gej *rj, const secp256k1_scalar *sec, uint64_t value, const secp256k1_ge* value_gen, const secp256k1_ge* blind_gen) {

    secp256k1_pedersen_ecmult_generic(rj, sec, value, value_gen, blind_gen, 1);
}
